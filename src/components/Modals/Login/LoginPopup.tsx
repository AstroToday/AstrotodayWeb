...
const LoginPopup = ({ onClose }: { onClose: () => void }) => {
  ...
  useEffect(() => {
    ...
    if (savedPhoneNumber) {
      ...
      setIsOtpStage(true); // Assuming OTP verification screen is open if phone number is present
    }
  }, []);
  const handlePhoneNumberChange = (e: ChangeEvent<HTMLInputElement>) => {
    const cleanedValue = e.target.value.replace(/[^0-9]/g, '');
    setPhoneNumber(cleanedValue);
    sessionStorage.setItem('phoneNumber', cleanedValue);
  };
              ...
              <div>
                ...
                <div className="phn_ctn bg-[#f6f6f6] w-full h-[2.906rem] flex items-center py-3 px-7 rounded-lg mb-2">
                  <div className="country flex items-center">
                    ...
                    <span className="text-[15.5px] font-normal mr-0.5">
                      +91
                    </span>
                ...
                <div className="text-center text-xs text-primary font-medium mb-6 w-full">
                  {' '}
                  You&apos;ll receive a single-use verification code via text
                  message
                </div>
                <div className="flex items-start justify-start ml-0.5 w-full">
                  ...
                  <div className="text-xs ml-2 font-normal ">
                    I permit astrotoday.com and their linked astrologers to
                    contact me using email, phone, or SMS.
                    <br />
                    Any doubts, you can{' '}
                    <a href="#">Check Terms and Condition</a>
                  </div>
                </div>
                  ...
                  <button
                    ...
                    className={`${
                      !isRadioChecked
                        ...
                        : 'bg-primary  hover:opacity-90 active:opacity-80 transition-opacity duration-[225ms]'
